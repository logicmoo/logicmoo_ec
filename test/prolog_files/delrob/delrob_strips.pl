...
clauze(at(Obj,Pos),[sitting_at(Obj,Pos)] ).
clauze(at(Obj,Pos),[autonomous(Ag), Ag \= Obj, carrying(Ag,Obj), at(Ag,Pos)]).

clauze(location(o109),[]).
clauze(location(o103),[]).
clauze(location(storage),[]).
clauze(location(o111),[]).
clauze(location(mail),[]).
clauze(location(lab2),[]).


clauze(adjacent(o109,o103),[]).
clauze(adjacent(o103,o109),[]).
clauze(adjacent(o109,storage),[]).
clauze(adjacent(storage,o109),[]).
clauze(adjacent(o109,o111),[]).
clauze(adjacent(o111,o109),[]).
clauze(adjacent(o103,mail),[]).
clauze(adjacent(mail,o103),[]).
clauze(adjacent(lab2,o109),[]).
clauze(adjacent(P_1,P_2), [blocks(Door,P_1,P_2), unlocked(Door)]).
clauze(blocks(door1,o103,lab2),[]).
clauze(opens(k1,door1),[]).
clauze(autonomous(rob),[]).
